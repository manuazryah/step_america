                                ...
                                <div class="nav-right">
                                        <ul class="navbar-nav">
                                                ...
                                                <li class="dropdown user user-menu">
                                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                                                <img src="/step_america/admin/img/user2-160x160.jpg" class="user-image" alt="User Image">
                                                                <span class="hidden-xs user-title">testing</span>
                                                        </a>
                                                        <ul class="dropdown-menu">
                                                                <!-- User image -->
                                                                <li class="user-header">
                                                                        <img src="/step_america/admin//img/user2-160x160.jpg" class="img-circle" alt="User Image">
                                                                        <p>
                                                                                testing                                                                                </p>
                                                                </li>
                                                                <!-- Menu Footer-->
